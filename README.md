...
- **Auto-launch.** Opening the app before noon with morning not yet done drops you straight into the morning flow; after noon, into the evening flow (if not already done) — no extra taps.
